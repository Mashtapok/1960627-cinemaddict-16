...
const createPopupTemplate = ({
  ...
  const createGenresTemplate = () => genre.map((genreName) => `<span class="film-details__genre">${genreName}</span>`).join('');
  ...
  <form class="film-details__inner" action="" method="get">
    <div class="film-details__top-container">
        ...
        <div class="film-details__info">
          ...
          <table class="film-details__table">
            ...
            <tr class="film-details__row">
              ...
              <td class="film-details__cell">${humanizePopupRealiseDate(release.date)}</td>
            </tr>
            <tr class="film-details__row">
      ...
      <section class="film-details__controls">
        ...
        <button type="button" class="film-details__control-button film-details__control-button--favorite ${isFavouriteClassName} " id="favorite" name="favorite">Add to favorites</button>
      </section>
    </div>
